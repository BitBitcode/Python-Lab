# 来源：https://blog.csdn.net/tongtongjing1765/article/details/100581918
...
class Graduate:
    ...
    def get_list(self):
        ...
        """
        self.get_list_fun(
            "http://yz.chsi.com.cn/zsml/pages/getSs.jsp", "province")
        self.get_list_fun(
            'http://yz.chsi.com.cn/zsml/pages/getMl.jsp', "category")
        self.get_list_fun(
            'http://yz.chsi.com.cn/zsml/pages/getZy.jsp', 'major')
    ...
    def get_school_url(self):
        ...
        schools_url = re.findall(
            '<a href="(.*?)" target="_blank">.*?</a>', str(content))
        return schools_url
